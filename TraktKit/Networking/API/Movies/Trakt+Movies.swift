...
public extension Trakt {
    ...
    public func getBoxOffice(completion: @escaping TraktResult<[BoxOfficeMovie]>) {
    ...
    public func getAliases(for movieId: TraktId, completion: @escaping TraktResult<[Alias]>) {
    ...
    public func getReleases(for movieId: TraktId, country: String, completion: @escaping TraktResult<[MovieRelease]>) {
    ...
    public func getComments(for movieId: TraktId, pageNumber: Int, resultsPerPage: Int = 10, sort: String, completion: @escaping TraktResult<[Comment]>) {
    ...
    public func getLists(for movieId: TraktId, type: String, sortBy: String, pageNumber: Int, resultsPerPage: Int = 10, completion: @escaping TraktResult<[List]>) {
    ...
    public func getPeople(for movieId: TraktId, completion: @escaping TraktResult<CastAndCrew>) {
    ...
    public func getRatings(for movieId: TraktId, completion: @escaping TraktResult<RatingDistribution>) {
    ...
    public func getRelatedMovies(for movieId: TraktId, pageNumber: Int, resultsPerPage: Int = 10, completion: @escaping TraktResult<[Movie]>) {
        fetchObject(ofType: [Movie].self,
    ...
    public func getStats(for movieId: TraktId, completion: @escaping TraktResult<Stats>) {
    ...
    public func getCurrentlyWatching(for movieId: TraktId, completion: @escaping TraktResult<[User]>) {
